    ...
    !(function(t, n) {
          ...
          function(e, t) {
            C.fn[e] = function(n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  (M[e] || C.uniqueSort(i), P.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
      ...
      function we(e, t, n, r, i) {
        ...
        for (f.textContent = '', d = 0; (o = p[d++]); )
          if (r && C.inArray(o, r) > -1) i && i.push(o);
            ...
            ((l = C.contains(o.ownerDocument, o)),
      ...
      function Ie(e, t, n, r) {
        ...
        var i,
          ...
          h = t[0],
          g = m(h);
        if (g || (p > 1 && 'string' == typeof h && !y.checkClone && Le.test(h)))
        ...
        if (
          ...
          for (s = (a = C.map(ve(i, 'script'), Pe)).length; f < p; f++)
            (u = i),
              f !== d &&
              ...
              (u = a[f]),
                he.test(u.type || '') &&
                  ...
                  (u.src && 'module' !== (u.type || '').toLowerCase()
                    ...
                    : w(u.textContent.replace(He, ''), c, u));
        }
        return e;
      }
      function We(e, t, n) {
            ...
            if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
              ...
              d))
                u ||
                  ...
                  g && fe([e], !0),
                  p.done(function() {
                    for (r in (g || fe([e]), K.remove(e, 'fxshow'), d))
                      C.style(e, r, d[r]);
                  })),
                  (u = lt(g ? v[r] : 0, r, p)),
                  r in v ||
      ...
      C.extend(C.event, {
        trigger: function(e, t, r, i) {
          ...
          if (
            ...
            if (!i && !p.noBubble && !x(r)) {
              for (
                l = p.delegateType || v, xt.test(l + v) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                g.push(s), (u = s);
            ...
            return (
              ...
              i ||
                ...
                (c &&
                  ...
                  ((u = r[c]) && (r[c] = null),
                  (C.event.triggered = v),
                  e.isPropagationStopped() && d.addEventListener(v, bt),
                  r[v](),
                  e.isPropagationStopped() && d.removeEventListener(v, bt),
            ...
            if (
              ...
              try {
                (l.href = h.url),
                  (l.href = l.href),
                  (h.crossDomain =
                    It.protocol + '//' + It.host != l.protocol + '//' + l.host);
              } catch (e) {
                h.crossDomain = !0;
              }
            }
      ...
      C.ajaxSetup({
        ...
        C.each(['top', 'left'], function(e, t) {
          C.cssHooks[t] = ze(y.pixelPosition, function(e, n) {
            if (n)
              return (n = _e(e, t)), $e.test(n) ? C(e).position()[t] + 'px' : n;
          });
        }),
      ...
      return (
        (C.noConflict = function(e) {
          return (
            n.$ === C && (n.$ = Gt), e && n.jQuery === C && (n.jQuery = Vt), C
          );
        }),
        i || (n.jQuery = n.$ = C),
        C
    ...
    i()(document).ready(function() {
      var e = function() {
        ...
        i()(window).resize(function() {
          ...
          i()('.awakeness').each(function() {
            var t = i()(this).offset().top + i()(this).height() / 2;
            t < i()(window).scrollTop() || t > i()(window).scrollTop() + e
              ? i()(this).addClass('sleep')
              : i()(this).removeClass('sleep');
          });
      };
        ...
        i()('a[href^="#"]').on('click', function(e) {
          ...
          if (t.length) {
            ...
            var n = i()(window).height(),
              r = t.offset().top - (n - Math.min(n, t.outerHeight())) / 4;
            i()('html, body')
              .stop()
              .animate({ scrollTop: r }, 1e3);
          }
        });
      }),
      i()(document).ready(function() {
        var e = i()('h2, h3, section'),
          t = i()('.sidebar-menu a');
        i()(window).on('scroll', function() {
          i()(this).scrollTop();
          var n = i()(window).scrollTop(),
            r = (i()(window).height(), n + i()(window).height() / 3);
          e.each(function() {
            var e = i()(this).offset().top,
              o = e + i()(this).outerHeight();
            if (e < r && o > n) {
              var a = i()(this).attr('id');
              t.removeClass('active'),
                i()('a[href="#' + a + '"]').addClass('active');
            } else {
              a = i()(this).attr('id');
              i()('a[href="#' + a + '"]').removeClass('active');
            }
          });
        });
      });
...
//# sourceMappingURL=main.02d45701.js.map
